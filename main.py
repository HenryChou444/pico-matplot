    ...
    for directory in input_section:
        ...
        for setting_folder in input_setting_directory:
            ...
            if setting_folder == "NOT_DEFINED":
                ...
                # format continued: invertColors_True;doted_1_2;legende_nom trace 1_nom trace 2
                ...
                for setting in settings:
                    ...
                    elif setting_data[0] == "invertColors":
                        invert_colors = setting_data[1] == "True"
                    elif setting_data[0] == "doted":
                        doted = set()
